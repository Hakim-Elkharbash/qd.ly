...
$fullname=mysql_real_escape_string(strval($_POST["fullname"]));
$email=mysql_real_escape_string(strval($_POST["email"]));
$phone=mysql_real_escape_string(strval($_POST["phone"]));
$massage=mysql_real_escape_string(strval($_POST["massage"]));

//-------------------- إرسال بريد الكتروني
$dat_tim=date('d/m/Y  H:i:s');
$to=$site_information[system_email];
$subject="مراسلة جديدة واردة من الموقع الالكتروني QDelivery";
...
<p class="style1"> إليكم رسالة جديدة وردت عن طريق الموقع الألكتروني للشركة.. </p>
<p class="style3">~~~~~~~~~~~~~~</p>
<p class="style3"> المرسل: <span style="background-color: #f3f3f5; direction:ltr;text-align:right"> '.$fullname.' </span></p>  
<p class="style3"> رقم الهاتف: <span style="background-color: #f3f3f5; direction:ltr;text-align:left;"> '.$phone.' </span></p>
<p class="style3"> نص الرسالة:<br> <span style="background-color: #f3f3f5; direction:ltr;text-align:left;"> '.$massage.' </span></p>
<p class="style3">~~~~~~~~~~~~~~</p>
...
تم إرسالة إستقبال رسالتكم بنجاح، سوف نرد عليكم في أقرب وقت ممكن. </div> '; 

}else{
echo '<div  style="font-size:20px; font-weight: bold; padding-bottom:20px">
<span class="fa fa-times fa-3x"></span>
لم تتم عملية إرسال الرسالة، يرجى المحاولة في وقت أخر.
</div> '; 
}
