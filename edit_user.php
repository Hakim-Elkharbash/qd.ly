        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-users fa-md"></i>  تعديل مستخدم.. </h4>
                </div>
                <div class="panel-body ">              
                    <form action="do_edit_user.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
                            <input type="hidden" name="idd" value="<? echo $qd_list[id]; ?>">                    
                      <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputName3" class="pull-right control-label fields-name"> الاسم ثلاثي</label>
                            <input type="text" name="fullname" value="<? echo $qd_list[fullname]; ?>" class="form-control input-lg" id="inputName3"  placeholder="الإسم الشخصي" >
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputEmail3" class="pull-right control-label fields-name" > البريد الإلكتروني</label>
                          <input type="email" name="email"  value="<? echo $qd_list[username]; ?>"  class="form-control input-lg" id="inputEmail3" style="text-align: left; direction: ltr" placeholder="البريد الإلكتروني" >
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                          ...
                          <input type="phone" name="phone"  value="<? echo $qd_list[phone]; ?>"  class="form-control input-lg" id="inputphone3" style="text-align: left; direction: ltr" placeholder=" رقم الهاتف" >
                        </div>
                      </div>
                         ...
                         <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputphone6" class="pull-right control-label fields-name" > نوع المستخدم</label>
                            <select name="userlist" class="form-control input-lg">
                            
                            <?
                            if ($qd_list[occupation]=='qd_employee'){
                            echo "
                             <option selected value='qd_employee'>موظف بـ QD</option>
                             <option value='cl_supervisor'>مشرف بـ CL</option>
                             <option value='cl_distributor'>مندوب بـ CL</option>
                             <option value='others'>أخرى</option> ";
                            }elseif($qd_list[occupation]=='cl_supervisor'){
                            echo "
                             <option value='qd_employee'>موظف بـ QD</option>
                             <option selected value='cl_supervisor'>مشرف بـ CL</option>
                             <option value='cl_distributor'>مندوب بـ CL</option>
                             <option value='others'>أخرى</option> ";
                            ...
                            echo "
                             <option value='qd_employee'>موظف بـ QD</option>
                             <option value='cl_supervisor'>مشرف بـ CL</option>
                             <option selected value='cl_distributor'>مندوب بـ CL</option>
                             <option value='others'>أخرى</option>";
                            }else{
                           echo "
                             <option value='qd_employee'>موظف بـ QD</option>
                             <option value='cl_supervisor'>مشرف بـ CL</option>
                             <option value='cl_distributor'>مندوب بـ CL</option>
                             <option selected value='others'>أخرى</option>";
                           }    
                            ?>
                        ...
                        <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputphone7" class="pull-right control-label fields-name" > رقم المستخدم (خاص بالمشرفين والمندوبين)</label>
                          <input type="text" name="user_no" class="form-control input-lg" value="<? echo $qd_list[user_no]; ?>"  id="inputphone7" style="text-align: left; direction: ltr" placeholder="رقم المستخدم" >
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputpass3" class="pull-right control-label fields-name" > تغير كلمة المرور</label>
                          <input type="text" name="password"  class="form-control input-lg" id="inputpass3" style="text-align: left; direction: ltr" placeholder="مخفي" >
                        </div>
                      </div>
                        
                        <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputsend3" class="pull-right control-label fields-name">
                                <input name="send_email" value="yes" type="checkbox" checked id="inputsend3"> إرسال بيانات الدخول الى بريد المستخدم.
                            </label>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-12 pull-right">
                          <button name="login_utton" type="submit" class="btn btn-primary btn-lg">تعديل البيانات </button>
		...
		var validator = $("#qd-form").bootstrapValidator({
			...
			fields : {
                ...
                userlist : {
					validators: {
						notEmpty : {
							message : "يجب تحديد نوع المستخدم"
						}
					}
				}, 
,
