        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-star fa-md"></i> إضافة حالة جديدة.. </h4>
                </div>
                <div class="panel-body ">             
                    <form action="do_add_state.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
                      <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputName1" class="pull-right control-label fields-name"> اسم الحالة - انجليزي </label>
                            <input type="text" name="ename" class="form-control input-lg" id="inputName1"  placeholder="اسم الحالة - انجليزي" style="text-align: left; direction: ltr">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputName2" class="pull-right control-label fields-name"> اسم الحالة - عربي </label>
                            <input type="text" name="aname" class="form-control input-lg" id="inputName2"  placeholder="اسم الحالة - عربي" >
                      ...
                      <div class="form-group">
                        <div class="col-sm-12 pull-right">
                          <button name="login_utton" type="submit" class="btn btn-primary btn-lg"> إضافة الحالة </button>
