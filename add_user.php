        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-users fa-md"></i>  إضافة مستخدم جديد.. </h4>
                </div>
                <div class="panel-body ">              
                    <form action="do_add_user.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          ...
                          <input type="text" name="user_no" class="form-control input-lg" id="inputphone7" style="text-align: left; direction: ltr" placeholder="رقم المستخدم" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-12 pull-right">
                          <button name="login_utton" type="submit" class="btn btn-primary btn-lg">التسجيل والانتقال لمنح الصلاحيات </button>
