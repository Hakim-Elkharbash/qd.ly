        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-key fa-md"></i>  تعديل كلمة المرور.. </h4>
                </div>
                <div class="panel-body ">             
                    <form action="do_edit_password.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
                        <input type="hidden" name="idd" value="<? echo $qd_list[id]; ?>">                    
                      <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputName1" class="pull-right control-label fields-name"> كلمة المرور الجديدة </label>
                            <input type="text" name="npass" class="form-control input-lg" id="inputName1"  placeholder="كلمة المرور الجديدة" style="text-align: left; direction: ltr">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputName2" class="pull-right control-label fields-name"> تأكيد كلمة المرور </label>
                            <input type="text" name="cpass" class="form-control input-lg"  id="inputName2"  placeholder="تأكيد كلمة المرور" style="text-align: left; direction: ltr">
                      ...
                      <div class="form-group">
                        <div class="col-sm-12 pull-right">
                          <button name="login_utton" type="submit" class="btn btn-primary btn-lg"> تعديل كلمة المرور </button>
		...
		var validator = $("#qd-form").bootstrapValidator({
			...
			fields : {
				npass : {
					validators: {
                        notEmpty : {
							message : "إدخل كلمة المرور"
						},
                        identical: {
                            field: 'cpass',
                            message : "يجب ان تتطابق كلمات المرور "
						},
                        stringLength: {
							min : 5, 
							max: 15,
							message: "يجب أن يزيد طول كلمة المرور 5 حروف أو ارقام ويقل عن 15"
						}
					}
				}, 
				cpass : {
