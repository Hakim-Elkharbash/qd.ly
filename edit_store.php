...
<?
$store_id=$_GET['id'];
$qd_list=mysql_fetch_array(mysql_query("SELECT * FROM qd_store WHERE id='$store_id'"));
 ?>
        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-archive fa-md"></i> تعديل مخزن Store.. </h4>
                </div>
                <div class="panel-body ">             
                    <form action="do_edit_store.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputName1" class="pull-right control-label fields-name"> اسم المخزن - انجليزي </label>
                            <input type="text" name="ename" class="form-control input-lg" value="<? echo $qd_list[store_en]; ?>" id="inputName1"  placeholder="اسم المخزن - انجليزي" style="text-align: left; direction: ltr">
                        </div>
                      </div>
                        
                      <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputName2" class="pull-right control-label fields-name"> اسم المخزن - عربي </label>
                            <input type="text" name="aname" class="form-control input-lg" value="<? echo $qd_list[store_ar]; ?>" id="inputName2"  placeholder="اسم المخزن - عربي" >
                      ...
                      <div class="form-group">
                        <div class="col-sm-12 pull-right">
                          <button name="login_utton" type="submit" class="btn btn-primary btn-lg"> تعديل المخزن </button>
		...
		var validator = $("#qd-form").bootstrapValidator({
			...
			fields : {
				ename : {
					validators: {
						notEmpty : {
							message : "يجب إدخال اسم المخزن بالانجليزي"
						}
					}
				}, 
				aname : {
					validators: {
						notEmpty : {
							message : "يجب إدخال اسم المخزن بالعربي"
						}
					}
				},
                arlist : {
					validators: {
						notEmpty : {
							message : "يجب أختيار اسم المدينة"
						}
					}
				}
			}
