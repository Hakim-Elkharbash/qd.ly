...
$result = mysql_query("DELETE FROM qd_orders WHERE id='$order_id'");
if ($result){
...
$order_infos=mysql_fetch_array(mysql_query("SELECT * FROM qd_orders WHERE id='$order_id'"));
$order_id=$order_infos[way_bill];
