...
$result = mysql_query("UPDATE setting SET zone_time='$znlist',default_language='$lglist',system_email='$email',rows='$rslist',receive_notifi='$ntlist',facebook='$face',keywords_ar='$key',description_ar='$des',copyright_ar='$copyright' WHERE id='1'");
