        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-10 col-lg-offset-1" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                   ...
                   <h4 style="text-align:right;"> <i class="fa fa-info-circle fa-md"></i> عرض تفصيلي للمخازن.. </h4>
                    ...
                    <form action="" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
                        ...
                        $xls_flag=true;
                            ...
                            if (($store_fg && $state_fg && $area_fg && $city_fg)||($all_flag)){
                                ...
                                //echo '<button name="login_utton" type="submit" class="btn btn-primary btn-lg"> Submit </button>';
                            }else{
...
echo '
<a href="list_orders_wide_view.php" target="_blank" class="btn btn-warning navbar-btn btn-sm pull-left">
...
<table class="table table-striped table-hover table-responsive" style="white-space: nowrap; max-width: none; width: auto;">
  <thead>
    <tr>';
      ...
      echo '<th style="text-align:center; " class="success">رقم الطلبية</th>';
      $xls_file[$row_xls][$col_xls]='رقم الطلبية';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">المخزن</th>';
      $xls_file[$row_xls][$col_xls]='المخزن';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">تاريخ الادخال/التعديل</th>';
      $xls_file[$row_xls][$col_xls]='تاريخ الادخال/التعديل';
      $col_xls++;
      ...
      $col_xls++;
      echo '<th style="text-align:center; " class="success">تسديد القيمة من</th>';
      $xls_file[$row_xls][$col_xls]='تسديد القيمة من';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">ترقيم الارفف</th>';
      $xls_file[$row_xls][$col_xls]='ترقيم الارفف';
      $col_xls++;
      ...
      $col_xls++;
      echo '<th style="text-align:center; " class="success">عنوان المستلم</th>';
      $xls_file[$row_xls][$col_xls]='عنوان المستلم';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">اسم المستلم</th>';
      $xls_file[$row_xls][$col_xls]='اسم المستلم';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">رقم المستلم</th>';
      $xls_file[$row_xls][$col_xls]='رقم المستلم';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">اسم المرسل</th>';
      $xls_file[$row_xls][$col_xls]='اسم المرسل<';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">كود المشرف</th>';
      $xls_file[$row_xls][$col_xls]='كود المشرف';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">رقم المرسل</th>';
      $xls_file[$row_xls][$col_xls]='رقم المرسل';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">ايميل او الكنية على الفيس للمستلم</th>';
      $xls_file[$row_xls][$col_xls]='ايميل او الكنية على الفيس للمستلم';
      $col_xls++;
      ...
      $col_xls++;
      echo '<th style="text-align:center; " class="success">نوعية السلعة</th>';
      $xls_file[$row_xls][$col_xls]='نوعية السلعة';
      $col_xls++;
      ...
      $col_xls++;
      echo '<th style="text-align:center; " class="success">ارسال المبلغ</th>';
      $xls_file[$row_xls][$col_xls]='ارسال المبلغ';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">تسليم قيمة الشحنة للمرسل</th>';
      $xls_file[$row_xls][$col_xls]='تسليم قيمة الشحنة للمرسل';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">تاريخ تسليم قيمة الشحنة للمرسل</th>';
      $xls_file[$row_xls][$col_xls]='تاريخ تسليم قيمة الشحنة للمرسل';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">الوزن</th>';
      $xls_file[$row_xls][$col_xls]='الوزن';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">الطول</th>';
      $xls_file[$row_xls][$col_xls]='الطول';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">العرض</th>';
      $xls_file[$row_xls][$col_xls]='العرض';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">الارتفاع</th>';
      $xls_file[$row_xls][$col_xls]='الارتفاع';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">QD1</th>';
      $xls_file[$row_xls][$col_xls]='QD1';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">QD2</th>';
      $xls_file[$row_xls][$col_xls]='QD2';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">QD3</th>';
      $xls_file[$row_xls][$col_xls]='QD3';
      $col_xls++;
      echo '<th style="text-align:center; " class="success">QD4</th>';
      $xls_file[$row_xls][$col_xls]='QD4';
      $col_xls++;
...
while($rows_xls=mysql_fetch_array($qd_list_xls)){
    $row_xls++;
    $col_xls=0;
    $xls_file[$row_xls][$col_xls]=$rows_xls[order_no];
    $col_xls++;  
    
    // $ar_info=mysql_fetch_array(mysql_query("SELECT * FROM qd_store WHERE store_en='$rows_xls[store]'"));
    // $xls_file[$row_xls][$col_xls]=$ar_info[store_ar];
    
    $xls_file[$row_xls][$col_xls]=$rows_xls[store];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[import_date];
    $col_xls++;   
    ...
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[payment_by];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[locker];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[area];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[city];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[consignee_address];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[consignee_name];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[consignee_phone];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[shipper_name];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[shipper_code];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[shipper_phone];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[facebook_email];
    $col_xls++;   
    ...
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[commodity];
    $col_xls++;   
    ...
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[money_transferred];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[money_returned_shipper];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[date_retunred_shipper];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[weigh];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[length];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[width];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[height];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[qd1];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[qd2];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[qd3];
    $col_xls++;   
    $xls_file[$row_xls][$col_xls]=$rows_xls[qd4];
    $col_xls++;   
