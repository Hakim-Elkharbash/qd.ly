...
$state_id=$_POST['idd'];
$state_en=$_POST['ename'];
$state_ar=$_POST['aname'];

$result = mysql_query("UPDATE qd_state SET state_en='$state_en',state_ar='$state_ar' WHERE id='$state_id'");
...
حدث خطأ في عملية التعديل، قد تكون هذه البيانات مضافة سابقا...
</div> '; 
