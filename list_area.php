        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-10 col-lg-offset-1" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-globe fa-md"></i> إدارة المناطق.. </h4>
                </div>
                <div class="panel-body ">              
                    
<?
$qd_list=mysql_query("SELECT * FROM qd_areas");
...
while($rows=mysql_fetch_array($qd_list)){
    echo '<tr>
      ...
      <td style="text-align:center;vertical-align: middle">'.$rows[area_en].'</td>
      <td style="text-align:center;vertical-align: middle">'.$rows[area_ar].'</td>
      <td style="text-align:center;vertical-align: middle">
        
        <a href="edit_area.php?id='.$rows[id].'" class="btn btn-info  btn-md navbar-btn">
                    تعديل&nbsp;
                <span class="fa fa-pencil-square-o"></span>
        </a>&nbsp;';
    
       if (mysql_numrows(mysql_query("SELECT * FROM qd_city WHERE area_id='$rows[id]'"))>0){
        echo '<a id="model-1" class="btn btn-danger btn-md navbar-btn disabled" onclick="msg_info('.$rows[id].')" href="javascript:void(0);">
            ...
            bootbox.dialog({
              ...
              buttons: {
                ...
                danger: {
                  ...
                  callback: function () {
                      location.href = "do_del_area.php?id="+xx;
                  }
                }
              }
            });
