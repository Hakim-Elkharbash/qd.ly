        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-10 col-lg-offset-1" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-map-marker fa-md"></i> إدارة المدن.. </h4>
                </div>
                <div class="panel-body ">              
                    
<?
$qd_list=mysql_query("SELECT * FROM qd_city");
...
while($rows=mysql_fetch_array($qd_list)){
    ...
    echo' <td style="text-align:center;vertical-align: middle">'.$rows[city_en].'</td>
      <td style="text-align:center;vertical-align: middle">'.$rows[city_ar].'</td>
      <td style="text-align:center;vertical-align: middle">
        
        <a href="edit_city.php?id='.$rows[id].'" class="btn btn-info  btn-md navbar-btn">
                    تعديل&nbsp;
            ...
            bootbox.dialog({
              ...
              buttons: {
                ...
                danger: {
                  ...
                  callback: function () {
                      location.href = "do_del_city.php?id="+xx;
                  }
                }
              }
            });
