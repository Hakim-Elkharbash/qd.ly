        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-paper-plane fa-md"></i>    تغيير حالة الباران (إستراد).. </h4>
                </div>
                <div class="panel-body ">             
                    <form action="do_import_alb_state.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm" enctype="multipart/form-data">
...
-->
                        ...
                        <div class="col-sm-12">
                            ...
                            <label for="inputName6" class="pull-right control-label fields-name"> يرجى بتحديد الملف </label>
