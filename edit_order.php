...
//---------------------------
$order_id=$_GET['id'];
$qd_list_ord=mysql_fetch_array(mysql_query("SELECT * FROM qd_orders WHERE id='$order_id'"));
        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-12" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                   <h4 style="text-align:right;"> <i class="fa fa-pencil-square-o fa-md"></i> تعديل طلبية.. [<a href="list_orders.php"> قائمة الطلبيات </a>] 
</h4> 
                </div>
                <div class="panel-body ">             
                    <form action="do_edit_order.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
                        
                        <input type="hidden" name="idd" value="<? echo $qd_list_ord[id]; ?>">                    
                        <div class="form-group">
                            
                            
                             <div class="col-sm-6">
                            <label for="inputName4" class="pull-right control-label fields-name"> رقم بوليصة الشحن &amp; البارن </label>
                            <input type="text" name="qdtex4" value="<? echo $qd_list_ord[way_bill]; ?>" class="form-control input-lg" id="inputName4"  placeholder="Way Bill" style="text-align: left; direction: ltr">
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <?
                            if ($qd_list_ord[service_type]=='COD'){
                            ...
                            <input type="text" name="qdtex6" oninput="calculate()" value="<? echo $qd_list_ord[amount]; ?>" class="form-control input-lg" id="inputName6"  placeholder="Amount" style="text-align: left; direction: ltr">
                        </div>
                     
                        <div class="col-sm-6">
                            <label for="inputName7" class="pull-right control-label fields-name"> سعر الخدمة </label>
                            <input type="text" name="qdtex7" oninput="calculate()" value="<? echo $qd_list_ord[service_charge]; ?>" class="form-control input-lg" id="inputName7"  placeholder="Service Charge" style="text-align: left; direction: ltr">
                        </div>
                      
                        <div class="col-sm-6">
                            <label for="inputName8" class="pull-right control-label fields-name"> إجمالي المبلغ </label>
                            <input type="text" name="qdtex8" readonly value="<? echo $qd_list_ord[total_amount]; ?>" class="form-control input-lg" id="inputName8"  placeholder="Total Amount" style="text-align: left; direction: ltr">
                        </div>
    ...
    document.getElementById('inputName8').value = Number(document.getElementById('inputName6').value) + Number(document.getElementById('inputName7').value);
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="qdtex9" class="form-control input-lg">
                                <?
                                if ($qd_list_ord[payment_by]=='Consignee'){
                                echo '<option selected value="Consignee">المستلم (Consignee)</option>
                                      <option value="Shipper">المرسل (Shipper)</option>';
                                }else{
                                    echo '<option value="Consignee">المستلم (Consignee)</option>
                                      <option selected value="Shipper">المرسل (Shipper)</option>';
                                }
                                ?>
                            </select>
                            ...
                            <input type="text" name="qdtex14" value="<? echo $qd_list_ord[consignee_name]; ?>" class="form-control input-lg" id="inputName14"  placeholder="Consignee Name" style="text-align: left; direction: ltr">
                        </div>
                      
                        <div class="col-sm-6">
                            <label for="inputName15" class="pull-right control-label fields-name">  رقم هاتف المستلم </label>
                            <input type="text" name="qdtex15" value="<? echo $qd_list_ord[consignee_phone]; ?>" class="form-control input-lg" id="inputName15"  placeholder="Consignee Phone" style="text-align: left; direction: ltr">
                        </div>
                            
                        <div class="col-sm-6">
                            <label for="inputName13" class="pull-right control-label fields-name">  عنوان المستلم </label>
                            <input type="text" name="qdtex13" value="<? echo $qd_list_ord[consignee_address]; ?>" class="form-control input-lg" id="inputName13"  placeholder="Consignee Address" style="text-align: left; direction: ltr">
                        </div>
                           ...
                           <div class="col-sm-6">
                            ...
                            <input type="text" name="qdtex5" value="<? echo $qd_list_ord[code]; ?>" class="form-control input-lg" id="inputName5"  placeholder="Code" style="text-align: left; direction: ltr">
                        </div>
                               ...
                               $qd_list_ar=mysql_query("SELECT * FROM qd_areas");
                                while($rows=mysql_fetch_array($qd_list_ar)){
                                  if (in_array($rows[id], $permissions_ar)){
                                    if ($qd_list_ord[area]==$rows[area_en]){
                                    echo "<option selected value='".$rows[area_en]."'>".$rows[area_ar]." (".$rows[area_en].")</option>";
                                    }else{
                            ...
                            <input type="text" name="qdtex19" value="<? echo $qd_list_ord[facebook_email]; ?>" class="form-control input-lg" id="inputName19"  placeholder="Email or Facebook" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex16" value="<? echo $qd_list_ord[shipper_name]; ?>" class="form-control input-lg" id="inputName16"  placeholder="Shipper Name" style="text-align: left; direction: ltr">
                        </div>
                               ...
                               $qd_list_ct=mysql_query("SELECT * FROM qd_city");
                                while($rows=mysql_fetch_array($qd_list_ct)){
                                  if (in_array($rows[id], $permissions_ct)){ 
                                    if ($qd_list_ord[city]==$rows[city_en]){
                                    echo "<option selected value='".$rows[city_en]."'>".$rows[city_ar]." (".$rows[city_en].")</option>";
                                    }else{
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="qdtex17" value="<? echo $qd_list_ord[shipper_code]; ?>" class="form-control input-lg" id="inputName17"  placeholder="Shipper Code" style="text-align: left; direction: ltr">
                        </div>
                
                         <div class="col-sm-6">
                            <label for="inputName18" class="pull-right control-label fields-name">  رقم هاتف المرسل </label>
                            <input type="text" name="qdtex18" value="<? echo $qd_list_ord[shipper_phone]; ?>" class="form-control input-lg" id="inputName18"  placeholder="Shipper Phone" style="text-align: left; direction: ltr">
                        </div>
                               ...
                               $qd_list_st=mysql_query("SELECT * FROM qd_store");
                                while($rows=mysql_fetch_array($qd_list_st)){
                                    if (in_array($rows[id], $permissions_st)){ 
                                        if ($qd_list_ord[store]==$rows[store_en]){
                                         echo "<option selected value='".$rows[store_en]."'>".$rows[store_ar]." (".$rows[store_en].")</option>";
                                        }else{
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="qdtex1" value="<? echo $qd_list_ord[order_no]; ?>"  class="form-control input-lg" id="inputName1"  placeholder="Order No." style="text-align: left; direction: ltr">
                        </div>
                               ...
                               $qd_list_stt=mysql_query("SELECT * FROM qd_state");
                                while($rows=mysql_fetch_array($qd_list_stt)){
                                  if (in_array($rows[id], $permissions_stt)){
                                    if ($qd_list_ord[shipment_state_en]==$rows[state_en]){
                                    echo "<option selected value='".$rows[state_en]."'>".$rows[state_ar]." (".$rows[state_en].")</option>";
                                    }else{
                       ...
                       <div class="col-sm-6">
                            ...
                            <input type="text" name="qdtex26" value="<? echo $qd_list_ord[commodity]; ?>" class="form-control input-lg" id="inputName26"  placeholder="Service Type" style="text-align: left; direction: ltr">
                        ...
                        <div class="col-sm-6">
                            <label for="inputName3" class="pull-right control-label fields-name"> إدخل التاريخ </label>
                                <input type='text' name="qdtex3" value="<? echo $qd_list_ord[import_date]; ?>" class="form-control input-lg" id='datetimepicker1' />
                        </div>
                       ...
                       <div class="col-sm-6">
                            <label for="inputName22" class="pull-right control-label fields-name"> تاريخ موعد التسليم </label>
                                <input type='text' name="qdtex22" value="<? echo $qd_list_ord[delivered_date]; ?>" class="form-control input-lg" id='datetimepicker3' />
                        </div>
                            ...
                            <input type="text" name="qdtex24" value="<? echo $qd_list_ord[total_pkgs]; ?>" class="form-control input-lg" id="inputName24"  placeholder="Total Pkgs" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex33" value="<? echo $qd_list_ord[weigh]; ?>" class="form-control input-lg" id="inputName33"  placeholder="Weigh" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex34" value="<? echo $qd_list_ord[length]; ?>" class="form-control input-lg" id="inputName34"  placeholder="Length" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex35" value="<? echo $qd_list_ord[width]; ?>" class="form-control input-lg" id="inputName35"  placeholder="Width" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex36" value="<? echo $qd_list_ord[height]; ?>" class="form-control input-lg" id="inputName36"  placeholder="Height" style="text-align: left; direction: ltr">
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="qdtex10" value="<? echo $qd_list_ord[locker]; ?>" class="form-control input-lg" id="inputName10"  placeholder="Locker" style="text-align: left; direction: ltr">
                        </div>
                      ...
                      <div class="col-sm-6">
                            <label for="inputName21" class="pull-right control-label fields-name"> تاريخ معاملة حالة الشحنة </label>
                                <input type='text' name="qdtex21" value="<? echo $qd_list_ord[shipment_date]; ?>" class="form-control input-lg" id='datetimepicker2' />
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <?
                            if ($qd_list_ord[alb_update]=='SENT'){
                             echo '<option selected value="SENT">SENT</option>
                             <option value="NOT SENT">NOT SENT</option>';
                            }else{
                             echo '<option value="SENT">SENT</option>
                             <option selected value="NOT SENT">NOT SENT</option>';
                            }
                            ?>
                            </select>   
                            </div>    
                            ...
                            <input type="text" name="qdtex25" value="<? echo $qd_list_ord[pkg_no]; ?>" class="form-control input-lg" id="inputName25"  placeholder="Pkg No." style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <label for="inputName28" class="pull-right control-label fields-name"> تاريخ الاخطار الاول </label>
                                <input type='text' name="qdtex28" value="<? echo $qd_list_ord[first_notice_date]; ?>" class="form-control input-lg" id='datetimepicker4' />
                        </div>
                            ...
                            <label for="inputName29" class="pull-right control-label fields-name"> تاريخ الإخطار الثاني </label>
                                <input type='text' name="qdtex29" value="<? echo $qd_list_ord[second_notice_date]; ?>" class="form-control input-lg" id='datetimepicker5' />
                        </div>
                            ...
                            <?
                            if ($qd_list_ord[money_transferred]=='تم الارسال'){
                            echo '<option selected value="تم الارسال">تم الارسال</option>
                             <option value="لم يتم الارسال">لم يتم الارسال</option>';
                            }else{
                            echo '<option  value="تم الارسال">تم الارسال</option>
                             <option selected value="لم يتم الارسال">لم يتم الارسال</option>';
                            }   
                            ?>
                            </select>   
                            </div> 
                            ...
                            <?
                            if ($qd_list_ord[money_returned_shipper]=='تم التسليم'){
                             echo '<option selected value="تم التسليم">تم التسليم</option>
                             <option value="لم يتم التسليم">لم يتم التسليم</option>';
                            }else{
                            echo '<option value="تم التسليم">تم التسليم</option>
                             <option selecteds value="لم يتم التسليم">لم يتم التسليم</option>';
                            }     
                            ?>
                            </select>   
                            </div> 
                            ...
                            <label for="inputName32" class="pull-right control-label fields-name"> تاريخ تسليم قيمة الشحنة للمرسل </label>
                                <input type='text' name="qdtex32" value="<? echo $qd_list_ord[date_retunred_shipper]; ?>" class="form-control input-lg" id='datetimepicker6' />
                        </div>
                            ...
                            <input type="text" name="qdtex37" value="<? echo $qd_list_ord[qd1]; ?>" class="form-control input-lg" id="inputName37"  placeholder="QD1" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex38" value="<? echo $qd_list_ord[qd2]; ?>" class="form-control input-lg" id="inputName38"  placeholder="QD2" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex39" value="<? echo $qd_list_ord[qd3]; ?>" class="form-control input-lg" id="inputName39"  placeholder="QD3" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex40" value="<? echo $qd_list_ord[qd4]; ?>" class="form-control input-lg" id="inputName40"  placeholder="QD4" style="text-align: left; direction: ltr">
                        </div>
                            ...
                            <input type="text" name="qdtex41" value="<? echo $qd_list_ord[comment]; ?>" class="form-control input-lg" id="inputName41"  placeholder="Comment" style="text-align: left; direction: ltr">
                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-12 pull-right">
                          <button name="login_utton" type="submit" class="btn btn-primary btn-lg"> تعديل الطلبية </button>
