        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-10 col-lg-offset-1" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-star fa-md"></i> إدارة الحالات.. </h4>
                </div>
                <div class="panel-body ">              
                    
<?
$qd_list=mysql_query("SELECT * FROM qd_state");
...
while($rows=mysql_fetch_array($qd_list)){
    echo '<tr>
      ...
      <td style="text-align:center;vertical-align: middle">'.$rows[state_en].'</td>
      <td style="text-align:center;vertical-align: middle">'.$rows[state_ar].'</td>
      <td style="text-align:center;vertical-align: middle">
        
        <a href="edit_state.php?id='.$rows[id].'" class="btn btn-info  btn-md navbar-btn">
                    تعديل&nbsp;
            ...
            bootbox.dialog({
              ...
              buttons: {
                ...
                danger: {
                  ...
                  callback: function () {
                      location.href = "do_del_state.php?id="+xx;
                  }
                }
              }
            });
