...
if ($arrayCount_r==$corr){
echo '<span class="fa fa-check fa-3x"></span>
لقد تم إستراد ('.$corr.') طلبية بنجاح (كل الطلبيات) وذلك من أصل ('.$arrayCount_r.') طلبية.
</div> '; 
}elseif ($corr==0){
echo '<span class="fa fa-times fa-3x"></span>
لم يتم إستراد إي طلبية من أصل ('.$arrayCount_r.') طلبية، السبب: قد تكون أضفت هذه الطلبيات مسبقاً.
</div> '; 
//echo mysql_error();
}else{
echo '<span class="fa fa-info fa-3x"></span>
لقد تم إستراد ('.$corr.') طلبية فقط من أصل ('.$arrayCount_r.') طلبية، السبب: قد تكون أضفت هذه الطلبيات مسبقاً.
</div> '; 
}
