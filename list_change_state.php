        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-10 col-lg-offset-1" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                   ...
                   <h4 style="text-align:right;"> <i class="fa fa-exchange fa-md"></i>    تغيير الحالة (يدوي).. </h4>
...
<form action="do_change_state.php" method="post"  id="qd-form2" name="qd-form-nm2">
    ...
    echo '
       <div class="well"  style="height: 90px">            
            <div class="col-sm-6">
                            <select name="change_to" class="form-control input-lg">';
                                echo "<option value=''> يرجى تحديد الحالة </option>";
                               $permissions_stt1= explode(" ",$qd_list1[access_status]);
                               print_r($permissions_stt1);
                               $qd_list_stt1=mysql_query("SELECT * FROM qd_state");
                                while($rows=mysql_fetch_array($qd_list_stt1)){
                                    if (in_array($rows[id], $permissions_stt1)){ 
                                        echo "<option value='".$rows[state_en]."'>".$rows[state_ar]." (".$rows[state_en].")</option>";
                                    }
                                }
            ...
            <div class="col-sm-3">
            <input type="test" name="change_date" value="'. date('Y-m-d') .' " class="form-control input-lg" id="datetimepicker1" />
            </div>
     ...
     echo '
       <div class="well"  style="height: 90px">            
            ...
            <div class="col-sm-3">
            <input type="test" name="change_date" value="'. date('Y-m-d') .' " class="form-control input-lg" id="datetimepicker1" disabled="disabled" />
            </div>
            <div class="col-sm-3">
		...
		var validator = $("#qd-form2").bootstrapValidator({
			...
			fields : {
                change_to : {
					validators: {
						notEmpty : {
							message : "يجب تحديد الحالة التى ترغب في التغيير إليه"
						}
					}
				}
			}
