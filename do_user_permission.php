...
$result = mysql_query("UPDATE sys_users_lp SET access_stores='$store',access_services='$services',access_status='$state',access_areas='$areas',access_city='$city' WHERE id='$user_id'"); 
...
حدث خطأ في عملية حفظ الصلاحيات...
</div> '; 
