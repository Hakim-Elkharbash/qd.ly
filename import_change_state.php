        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-exchange fa-md"></i>    تغيير الحالة (إستراد).. </h4>
                </div>
                <div class="panel-body ">             
                    <form action="do_import_change_state.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm" enctype="multipart/form-data">
