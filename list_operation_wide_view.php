...
<th style="text-align:center; " class="success">رقم البوليصة / الباران</th>
<th style="text-align:center; " class="success">العملية</th>';
//<th style="text-align:center; " class="success">التفاصيل</th>
echo '<th style="text-align:center; " class="success">المستخدم</th>
<th style="text-align:center; " class="success">الوقت والتاريخ</th>
  </thead>
  <tbody>';
...
while($rows=mysql_fetch_array($qd_list)){
    echo '<tr>
      ...
      <td style="text-align:center;vertical-align: middle">'.$rows[operation].' ('.$rows[details].')</td>';
      //<td style="text-align:center;vertical-align: middle">'.$rows[details].'</td>
     echo '<td style="text-align:center;vertical-align: middle">'.$rows[user_info].'</td>
