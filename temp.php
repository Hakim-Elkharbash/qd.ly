 ...
 <!-- Navbar -->
  	<nav class="navbar navbar-inverse navbar-fixed-top " id="my-navbar">
  		<div class="container">
  			<div class="navbar-header">
                ...
                <a href="login.php" class="btn btn-success btn-md navbar-btn">
                    تسجيل الدخول&nbsp;
    ...
    <div class="jumbotron">
  		<div class="container text-center">
            <h1 style="font-family: serif; padding-bottom: 15px">Q.Delivery - Libya</h1>
  			<p>للشحن داخل مدن ليبيا،،، هدفنا هو تقريب المسافات بين المستثمرين ومتسوقي الانترنت</p>  
   </div>
</div>         
