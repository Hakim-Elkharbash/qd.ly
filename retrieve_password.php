        ...
        <div class="text-center">
            <div class="panel panel-default col-lg-6 col-lg-offset-3" style="padding-bottom:20px !important">
               <div class="panel-heading" style="background-color: burlywood !important">
                    <h4 style="text-align:right;"> <i class="fa fa-unlock fa-md"></i> إستعادة كلمة المرور.. </h4>
                </div>
                <div class="panel-body ">              
                    <form action="do_retrieve_password.php" method="post" class="form-horizontal" id="qd-form" name="qd-form-nm">
